    ...
    'scope: 'scope,
{
    ...
    unsafe {
        Ok(match result_type {
            ...
            NativeType::Pointer | NativeType::Function | NativeType::Buffer => NativeValue {
...
fn ffi_call(
    ...
    unsafe {
        Ok(match result_type {
            ...
            NativeType::Bool => FfiValue::Value(Value::from(cif.call::<bool>(fun_ptr, &call_args))),
            NativeType::U8 => FfiValue::Value(Value::from(cif.call::<u8>(fun_ptr, &call_args))),
            NativeType::I8 => FfiValue::Value(Value::from(cif.call::<i8>(fun_ptr, &call_args))),
            NativeType::U16 => FfiValue::Value(Value::from(cif.call::<u16>(fun_ptr, &call_args))),
            NativeType::I16 => FfiValue::Value(Value::from(cif.call::<i16>(fun_ptr, &call_args))),
            NativeType::U32 => FfiValue::Value(Value::from(cif.call::<u32>(fun_ptr, &call_args))),
            NativeType::I32 => FfiValue::Value(Value::from(cif.call::<i32>(fun_ptr, &call_args))),
            NativeType::U64 => FfiValue::Value(Value::from(cif.call::<u64>(fun_ptr, &call_args))),
            NativeType::I64 => FfiValue::Value(Value::from(cif.call::<i64>(fun_ptr, &call_args))),
            NativeType::USize => {
            ...
            NativeType::F32 => FfiValue::Value(Value::from(cif.call::<f32>(fun_ptr, &call_args))),
            NativeType::F64 => FfiValue::Value(Value::from(cif.call::<f64>(fun_ptr, &call_args))),
            NativeType::Pointer | NativeType::Function | NativeType::Buffer => FfiValue::External(
                ExternalPointer::from(cif.call::<*mut c_void>(fun_ptr, &call_args)),
            ),
            NativeType::Struct(_) => {
    ...
    FP: FfiPermissions + 'static,
{
    ...
    let out_buffer = out_buffer.map(|v| v8::Local::<v8::TypedArray>::try_from(v.v8_value).unwrap());
