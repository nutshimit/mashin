...
pub use crate::dlfcn::DynamicLibraryResource;
pub use crate::ir::{NativeValue, OutBuffer};
pub use crate::symbol::{NativeType, Symbol};
...
fn event_loop_middleware(op_state_rc: Rc<RefCell<OpState>>, _cx: &mut std::task::Context) -> bool {
...

    {
        ...
        while let Ok(Some(async_work_fut)) = ffi_state.async_work_receiver.try_next() {
