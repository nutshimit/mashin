...
use crate::log;
use crate::{NativeValue, Result};
use anyhow::anyhow;
use deno_core::{error::generic_error, Resource};
use dlopen::raw::Library;
use libffi::middle::Arg;
use mashin_sdk::{CliLogger, ResourceArgs, ResourceResult};
...
impl DynamicLibraryResource {
    pub fn call_new(&self, props_ptr: *mut c_void) -> Result<*mut c_void> {
        let symbol = self
            .symbols
            .get("new")
            .ok_or(anyhow!("valid `drop` symbol"))?;
    ...
    pub fn call_resource(
        ...
        let res = unsafe {
            ...
            symbol
                .cif
                .call::<*mut ResourceResult>(symbol.ptr, &call_args)
        };
